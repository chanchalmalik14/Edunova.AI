      ...
      <div className="flex-1 p-8 overflow-y-auto">
        ...
        {activeTab === "mark" && (
          <div className="mt-12 space-y-8">
            <div className="bg-white/[0.04] border border-white/10 rounded-3xl p-8 grid md:grid-cols-2 gap-6">
              <div>
        ...
        {activeTab === "history" && (
          <div className="mt-12 space-y-8">
            <form onSubmit={handleFetchHistory} className="bg-white/[0.04] border border-white/10 rounded-3xl p-8 grid md:grid-cols-3 gap-6 items-end">
              <div>
